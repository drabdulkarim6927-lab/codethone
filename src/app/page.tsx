        ...
        <section id="about" className="py-20 px-4 bg-white">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-14">
              <h2 className="section-title">ما هو كودثون (Codethon)؟</h2>
              <p className="section-subtitle max-w-2xl mx-auto">
                برنامج تقني مكثف يتيح للطلاب الموهوبين تصميم وتطوير نماذج أولية لتطبيقات الهاتف والويب باستخدام الذكاء الاصطناعي التوليدي، وتحويل الأفكار الابتكارية إلى حلول تقنية قابلة للتطبيق.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  desc: "صمّم وطوّر نموذجًا أوليًا لتطبيق هاتف أو ويب، واعرض مشروعك أمام لجنة تحكيم متخصصة.",
                },
                {
                  icon: "🤖",
                  title: "الذكاء الاصطناعي التوليدي",
                  desc: "استخدم أدوات الذكاء الاصطناعي التوليدي كمساعد برمجي لتسريع تطوير الحلول التقنية وبناء التطبيقات المبتكرة.",
                },
                {
                  icon: "🚀",
                  title: "الابتكار وريادة الأفكار",
                  desc: "طوّر فكرة مبتكرة تعالج تحديًا واقعيًا، وحوّلها إلى نموذج أولي قابل للتطبيق باستخدام التقنيات الحديثة.",
                },
              ].map((item) => (
